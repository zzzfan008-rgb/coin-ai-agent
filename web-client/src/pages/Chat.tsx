...
import { Menu, PanelRight, AlertCircle } from 'lucide-react'
    ...
    <div className="flex h-full overflow-hidden bg-bg">
      ...
      <div className="hidden shrink-0 lg:block">
        <Sidebar
          ...
          user={user}
          onSelect={(s) => void chat.selectSession(s)}
